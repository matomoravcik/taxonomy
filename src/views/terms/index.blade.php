    ...
    <div class="col-md-6">
      ...
      <div class="box box-primary">
          ...
          <div class="box-header">
              <div class="btn-group">
                  {!! Form::open(array('method' => 'GET', 'url' => action('\MatoMoravcik\Taxonomy\Controllers\TaxonomyController@getIndex'))) !!}
                  {!! Form::button(Lang::get('taxonomy::vocabulary.edit.button.back'), array('class'=>'btn btn-primary btn-flat', 'type' => 'submit')) !!}
                  {!! Form::close() !!}
              </div>
              <div class="btn-group">
                  {!! Form::open(array('method' => 'GET', 'url' => action('\MatoMoravcik\Taxonomy\Controllers\TermsController@getCreate', $vocabulary->id))) !!}
                ...
                <li class="dd-item" data-id="{!! $parent['term']->id !!}">
                  ...
                  <div class="handle dd-handle">
                    ...
                    <div class="pull-right">
                      <div class="btn-group">
                        {!! Form::open(array('method' => 'GET', 'url' => action('\MatoMoravcik\Taxonomy\Controllers\TermsController@getEdit', $parent['term']->id))) !!}
                        {!! Form::button(Lang::get('taxonomy::vocabulary.button.edit'), array('class'=>'btn btn-xs btn-primary btn-flat', 'type' => 'submit')) !!}
                        {!! Form::close() !!}
                      </div>

                      <div class="btn-group">
                        {!! Form::open(array('method' => 'DELETE', 'url' => action('\MatoMoravcik\Taxonomy\Controllers\TermsController@deleteDestroy', $parent['term']->id))) !!}
                    ...
                    @foreach ($parent['children'] as $term_weight => $child)
                      <li class="dd-item" data-id="{!! $child->id !!}">
                        ...
                        <div class="handle dd-handle">
                          ...
                          <div class="pull-right">
                            <div class="btn-group">
                              {!! Form::open(array('method' => 'GET', 'url' => action('\MatoMoravcik\Taxonomy\Controllers\TermsController@getEdit', $child->id))) !!}
                              {!! Form::button(Lang::get('taxonomy::vocabulary.button.edit'), array('class'=>'btn btn-xs btn-primary btn-flat', 'type' => 'submit')) !!}
                              {!! Form::close() !!}
                            </div>

                            <div class="btn-group">
                              {!! Form::open(array('method' => 'DELETE', 'url' => action('\MatoMoravcik\Taxonomy\Controllers\TermsController@deleteDestroy', $child->id))) !!}
                              {!! Form::button(Lang::get('taxonomy::vocabulary.button.delete'), array('class'=>'delete-confirm-dialog btn btn-xs btn-danger btn-flat', 'type' => 'submit')) !!}
                              {!! Form::close() !!}
                            </div>
                          </div>
  ...
  <script>
   $(function() {
     ...
     $('.dd').on('change', function() {
       ...
       $.ajax({
         url: '{!! action('\MatoMoravcik\Taxonomy\Controllers\TaxonomyController@postOrderTerms', $vocabulary->id) !!}',
         type: 'post',
         data: {
           json
         },
