...
@section($layout->content)
  ...
  <div class="row">
    ...
    {!! Form::model($vocabulary, array('method' => 'PUT', 'url' => action('\MatoMoravcik\Taxonomy\Controllers\TaxonomyController@putUpdate', $vocabulary->id), 'id' => 'app-create', 'class' => 'form')) !!}
